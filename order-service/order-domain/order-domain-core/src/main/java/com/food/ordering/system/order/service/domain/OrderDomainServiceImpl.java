...
public class OrderDomainServiceImpl implements OrderDomainService {
  ...
  public OrderCreatedEvent validateAndInitiate(Order order, Restaurant restaurant) {
    validateRestuarant(restaurant);
    setOrderProductInformation(order, restaurant);
    order.validateOrder();
    order.initializeOrder();
    log.info("Order with Id: {} is initiated", order.getId().getValue());
    return new OrderCreatedEvent(order, getZonedDateTime());
  }
  ...
  public OrderPaidEvent payOrder(Order order) {
    ...
    return new OrderPaidEvent(order, getZonedDateTime());
  }
  ...
  public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failureMessages) {
    ...
    return new OrderCancelledEvent(order, getZonedDateTime());
  }
  ...
  private void validateRestuarant(Restaurant restaurant) {
